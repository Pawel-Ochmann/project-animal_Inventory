...
router.post('/categories/:name/update', category_controller.category_update_post);
router.post('/categories/:name/delete', category_controller.category_delete_post);
